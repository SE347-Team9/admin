    ...
    try {
      ...
      if (response.success) {
        const transformedReports = response.data.map(report => ({
          ...
          code: report.code,
          type: report.type as 'import' | 'distribution' | 'debt',
          typeLabel: report.type === 'import' ? 'Nhập kho' : report.type === 'distribution' ? 'Phân phối' : 'Công nợ',
          period: `${report.month}/${report.year}`,
          value: 0, // Value calculated from data
          employee: 'Nhân viên', // Get from createdBy
      ...
      <div className="reports-section">
        <div className="section-header">
          ...
          <button 
            ...
            onClick={() => navigate('/staff/add-report')}
          >
            <FileText size={20} />
            Lập báo cáo
          </button>
